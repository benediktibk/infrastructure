...
nft add rule filter FORWARD-DMZ-INTERNAL ip saddr 192.168.38.0/24 ip daddr 192.168.39.3 tcp dport 53 counter accept
echo "    allow ICMP requests"
...
add_forward_rule_from_vpn tcp 139 192.168.39.17
...
add_forward_rule_from_vpn tcp 445 192.168.39.17
